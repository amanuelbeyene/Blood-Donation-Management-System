        ...
        <aside className="w-64 bg-gray-900 text-white min-h-screen">
            <nav className="p-4 space-y-2">
                ...
                <NavLink
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition ${isActive('/super-admin-dashboard')
                ...
                <NavLink
                    to="/admin/donations"
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition ${isActive('/admin/donations')
                        ? 'bg-purple-600 text-white'
                        : 'hover:bg-gray-800 text-white'
                        }`}
                >
                ...
                <NavLink
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition ${isActive('/admin/blood-stock')
                        ? 'bg-purple-600 text-white'
                        : 'hover:bg-gray-800 text-white'
                        }`}
                >
