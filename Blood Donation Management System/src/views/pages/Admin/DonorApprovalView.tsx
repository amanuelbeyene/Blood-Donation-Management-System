                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div><p className="text-sm text-gray-500">Full Name</p><p className="font-medium">{selectedDonor.fullName}</p></div>
                                    <div><p className="text-sm text-gray-500">Email</p><p className="font-medium">{selectedDonor.email}</p></div>
                                    <div><p className="text-sm text-gray-500">Phone</p><p className="font-medium">{selectedDonor.phone}</p></div>
                                    <div><p className="text-sm text-gray-500">Blood Type</p><p className="font-medium">{selectedDonor.bloodType}</p></div>
                                    <div><p className="text-sm text-gray-500">Age</p><p className="font-medium">{selectedDonor.age || 'N/A'}</p></div>
                                    <div><p className="text-sm text-gray-500">Location</p><p className="font-medium">{selectedDonor.location}</p></div>
                                    <div><p className="text-sm text-gray-500">Username</p><p className="font-medium">{selectedDonor.username}</p></div>
                                </div>
                                {selectedDonor.locationDetails && (
                                    <div className="mt-4 border-t pt-4">
                                        <h4 className="text-sm font-semibold mb-2">Detailed Address</h4>
                                        <p className="text-sm">{selectedDonor.locationDetails.region}, {selectedDonor.locationDetails.city}, {selectedDonor.locationDetails.woreda}</p>
                                    </div>
                                )}
                            </div>
