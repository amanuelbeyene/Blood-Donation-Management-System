...
const AppRoutes = () => (
  <Routes>
    ...
    <Route element={<AdminLayout />}>
      ...
      <Route path="/admin/find-hospital" element={<AdminFindHospitalView />} />
    ...
    <Route element={<SuperAdminLayout />}>
      ...
      <Route path="/super-admin/donations" element={<DonationsView />} />
      <Route path="/super-admin/blood-requests" element={<BloodRequestsView />} />
      <Route path="/super-admin/request-history" element={<RequestHistoryView />} />
      <Route path="/super-admin/blood-stock" element={<BloodStockView />} />
    </Route>
  </Routes>
);
